...
namespace Home_Loan
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<Home_LoanContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Home_Loan", Version = "v1" });
            });
